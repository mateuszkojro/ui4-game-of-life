...
void SimpleConsoleRenderer::draw_square(const Coord &position, int size_x,
                                        int size_y, const Color &fill) {
...
void SimpleConsoleRenderer::set_pixel(const Coord &position,
                                      const Color &fill) {
  video_buffer_[translate(position)] = color_to_pixel(fill);
}

void SimpleConsoleRenderer::show_text_big(const Coord &position,
...
void SimpleConsoleRenderer::show_text_medium(const Coord &position,
                                             const std::string &text) {
  int x = position.x;
...
void SimpleConsoleRenderer::show_text_small(const Coord &position,
                                            const std::string &text) {
