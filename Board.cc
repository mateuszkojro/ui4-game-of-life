...
Board::Board(bool *board, size_t x, size_t y) : size_x_(x), size_y_(y) {
  board_ = board;
}
...
size_t Board::size_x() const { return size_x_; }

size_t Board::size_y() const { return size_y_; }
...
bool *Board::get_board() const { return board_; }
...
Board::Board(const Board &other) { copy(other); }
...
unsigned Board::size() const { return size_x_ * size_y_; }
...
bool &Board::operator()(int i) { return board_[i]; }

bool &Board::operator()(int x, int y) {
  return operator()(translate_adress(x, y));
}

bool &Board::operator()(int i) const { return board_[i]; }
