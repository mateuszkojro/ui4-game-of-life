...
protected:
  ...
  /// \brief This function will be invoked on every world tick should be
  /// ovverided by the derriving class
  virtual void on_tick() = 0;

  /// \brief This function is called when the game ends should be ovverided by
  /// the derriving class
